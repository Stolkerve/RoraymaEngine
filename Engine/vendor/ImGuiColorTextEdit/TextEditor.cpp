...
const TextEditor::LanguageDefinition& TextEditor::LanguageDefinition::Python()
{
	...
	{
		static const char* const keywords[] = {
			"False", "await", "else", "import", "pass", "None", "break", "except", "in", "raise", "True", "class", "finally", "is", "return", "and", "continue", "for", "lambda", "try", "as", "def",
			"from", "nonlocal", "while", "del", "global", "not", "with", "async", "elif", "if", "or", "yield", "self",
		};
		...
		static const char* const identifiers[] = {
			"assert", "print", "abs", "ascii", "all", "bin", "bool", "bytearray", "bytes", "callable", "classmethod", "compile", "complex", "delattr", "dict", "dir", "divmod", "enumerate", "eval", "exec",
			"filter", "float", "format", "frozenset", "getattr", "globals", "hasattr", "hash", "help", "hex", "id", "input", "int", "isinstance", "issubclass", "iter", "len", "list", "locals", "map", "max",
			"memoryview", "min", "next", "object", "oct", "open", "ord", "pow", "property", "range", "repr", "reversed", "round", "set", "setattr", "slice", "sorted", "@staticmethod", "str", "sum", "super",
			"tuple", "type", "vars", "zip"
		};
		for (auto& k : identifiers)
		{
